...
const TabletForm = ({ storeId, onSuccess, onError }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await productsAPI.createTablet(payload);
      ...
      onError?.(err.message || 'Failed to add tablet');
    } finally {
      setSaving(false);
    }
  };
