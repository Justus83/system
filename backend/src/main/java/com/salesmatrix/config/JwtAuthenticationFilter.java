package com.salesmatrix.config;

import com.salesmatrix.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        System.out.println("JWT Filter - Method: " + request.getMethod() + ", Path: " + request.getRequestURI());
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (jwtService.isTokenValid(jwt, userDetails)) {
                    ...
                    System.out.println("JWT Filter - Authentication successful for: " + userEmail);
                } else {
